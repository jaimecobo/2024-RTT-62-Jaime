...
public class ArrayInsertFunction {
    public int[] insert(int[] source, int insertPosition, int valueToInsert) {
    ...
    public int[] delete(int[] source, int deletePosition) {
        return null;
    }
    ...
    public static void main(String[] args) {
        ArrayInsertFunction main = new ArrayInsertFunction();
        main.run();
    }
